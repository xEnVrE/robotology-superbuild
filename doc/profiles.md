...
operating system-specific installation documentation. To compile `matio-cpp`, [tbeu/matio](https://github.com/tbeu/matio/) is a mandatory dependency.

[tbeu/matio](https://github.com/tbeu/matio/) is aslo an optional system dependency of `wb-toolbox`.
...
On windows the installation of `CppAD` is currently disabled because of https://github.com/coin-or/CppAD/pull/63 and https://github.com/coin-or/CppAD/pull/61. The user can however install CppAD with `vcpkg`. 
